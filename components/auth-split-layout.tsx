    ...
    >
      ...
      <div
        className={cn(
          ...
          "2xl:overflow-hidden 2xl:rounded-2xl 2xl:border 2xl:border-border 2xl:bg-background/95 2xl:shadow-[0_25px_80px_-24px_rgba(0,0,0,0.75)]",
          frameClassName,
        )}
      >
        <div
          className={cn(
            "relative hidden flex-1 overflow-hidden border-border border-r lg:block",
            leftClassName,
          )}
        >
          {left}
